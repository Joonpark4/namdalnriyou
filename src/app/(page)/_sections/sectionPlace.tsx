  ...
  return (
    <div className="flex w-full flex-col gap-5">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-1">
          <h4 className="text-lg font-semibold">
            벚꽃 길과 함께 즐기는 경호강 앞의 리버뷰
          </h4>
          <p>
            봄이면 벚꽃이 만개하는 길을 따라 걷다 보면, 어느새 강변 앞에 자리한
            우리 카페에 도착하게 됩니다. 카페 내부에서도 경호강을 한눈에
            내려다볼 수 있는 환상적인 리버뷰를 자랑합니다. 산들바람을 맞으며
            벚꽃과 함께 즐기는 커피 한 잔은 그 어떤 곳에서도 경험할 수 없는
            특별한 순간을 선사합니다.
          </p>
        </div>
        <div className="space-y-1">
          ...
          <p>
            ...
            제공합니다. 노르웨이에서 직접 공수된 아라비아핀란드, 피기오,
            로스트란드와 같은 대표적 북유럽 빈티지 그릇은 커피와 디저트를 더욱
            특별하게 만들어줍니다.
          </p>
        </div>
      </div>
