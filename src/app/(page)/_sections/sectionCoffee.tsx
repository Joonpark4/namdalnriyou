    ...
    <div className="flex w-full flex-col gap-5">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-1">
          ...
          <p>
            우리 카페는 SCA(Specialty Coffee Association) 공인 국제 바리스타가
            직접 만들어주는 커피를 제공합니다. 각각의 커피가 지닌 고유의
            특성을 최대한 끌어내어, 매 순간 최상의 커피를 제공해드립니다. 정교한 기술과 노하우로
            완성된 맛있는 커피는 이 카페가 남다른 이유입니다.
          </p>
        </div>
      </div>
    </div>
