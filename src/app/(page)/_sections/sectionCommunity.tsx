    ...
    <div className="flex w-full flex-col gap-5 py-7">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-1">
          ...
          <p>
            우리 카페는 지역 주민들과의 소통과 협력을 통해 상생의 가치를 실현하며,
            다양한 프로그램과 활동의 장이 되어 산청 지역 사회와 함께 성장합니다.
          </p>
          <p>
            이곳은 지역 학생들의 공부방, 지역 밴드를 위한 합주실, 사진전이 열리는 전시회가 됩니다. 때로는 나눔 바자회에서 지역 주민들이 참여해 필요 없는 물품을 나누고, 수익금은 지역 사회에 다시 환원합니다.
          </p>
        </div>
        <div className="space-y-1">
