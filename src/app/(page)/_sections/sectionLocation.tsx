    ...
    />
      <div className="flex flex-col gap-2 relative">
        <div className="flex flex-col gap-2">
          ...
          <Button variant={"outline"} onClick={isitializeMap} className="absolute top-1 right-1">매장으로</Button>
        </div>
        <div className="flex justify-end">
          <Link href={"https://map.naver.com/p/entry/place/1980392936?c=15.00,0,0,0,dh"}>
      ...
      <Script 
        ...
        <div className="space-y-1">
          ...
          <p>
            매장 내에 넓은 전용 주차장이 있어 주차에 불편함이 없습니다. 남강을 드라이브하며 아름다운 자연을 감상하는 길에, 잠시 들러 맛있는 마카롱을 맛보러 오세요.
          </p>
        </div>
    </div>
  );
